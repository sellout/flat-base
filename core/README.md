...
[![Hackage Version](https://img.shields.io/hackage/v/flat-base)](https://hackage.haskell.org/package/flat-base)
[![Packaging status](https://repology.org/badge/tiny-repos/haskell:flat-base.svg)](https://repology.org/project/haskell:flat-base/versions)
[![latest packaged versions](https://repology.org/badge/latest-versions/haskell:flat-base.svg)](https://repology.org/project/haskell:flat-base/versions)

base without recursion

This is the base library, but with everything that involves recursion stripped out.
...
This package is licensed under [The GNU AGPL 3.0 only](./LICENSE). If you need a license for usage that isn’t covered under the AGPL, please contact [Greg Pfeil](mailto:greg@technomadic.org?subject=licensing%20flat-base).
